...
const file_hello_proto_rawDesc = "" +
	"\n" +
	"\vhello.proto\x12\x05hello\"\x1d\n" +
	"\aRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\"\x1c\n" +
	"\bResponse\x12\x10\n" +
	"\x03msg\x18\x01 \x01(\tR\x03msg21\n" +
	"\x03Say\x12*\n" +
	"\x05Hello\x12\x0e.hello.Request\x1a\x0f.hello.Response\"\x00B?Z=github.com/emran/microservices-go/protocol-buffer/proto;hellob\x06proto3"
